...
try:
    ...
    import re
from DHParser import start_logging, is_filename, Grammar, Compiler, Whitespace, Drop, Alternative, Text, Synonym, Interleave, Option, OneOrMore, RegExp, Series, TreeReduction, ZeroOrMore, Forward, NegativeLookahead, CombinedParser, mixin_comment, compile_source, PreprocessorFunc, Node, TransformerCallable, traverse, change_name, recompile_grammar, set_config_value, get_config_value, access_presets, finalize_presets, ErrorCode, set_tracer, resume_notices_on, trace_history, ThreadLocalSingletonFactory, Error, canonical_error_strings, has_errors, ERROR, FATAL, set_preset_value, NEVER_MATCH_PATTERN, gen_find_include_func, preprocess_includes, make_preprocessor, chain_preprocessors, pick_from_path, get_config_values, md5, StringView, as_list
